      ...
      {aboutData ? (
        <div className="min-w-full">
          ...
          >
            ...
            <h2 className="text-lg font-extrabold px-2 lg:text-5xl  text-center lg:mt-8">
              <span className="text-transparent bg-clip-text bg-gradient-to-r to-sky-600 from-yellow-400 ">
                {aboutData?.title}
              </span>
            </h2>
            <p className="text-sm font-normal lg:text-xl opacity-60 px-8 text-center lg:w-2/3 mx-auto lg:py-6 py-2">
              {aboutData?.info}
            </p>
          </AnimatedFadeInContainer>
          <Skills />
