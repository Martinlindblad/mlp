  ...
  return (
    <main className="flex pt-32 lg:p-60 lg:justify-center w-full lg:container min-h-screen">
      <div className="min-w-full">
        ...
        >
          <h2 className="text-2xl font-extrabold px-2 md:text-5xl lg:text-6xl text-center lg:mt-8">
            <span className="text-transparent bg-clip-text bg-gradient-to-r to-sky-600 from-yellow-400 ">
              {aboutData?.title}
            </span>
          </h2>
          <p className="text-lg font-normal lg:text-xl opacity-60 px-8 text-center lg:w-2/3 mx-auto md:py-6 py-2">
            {aboutData?.info}
          </p>
          <div className="flex flex-row justify-center pt-8 md:pt-5">
            <AboutCard />
          </div>
        </AnimatedFadeInContainer>
        <div className="pt-16">
